...
<div class="container mt-5">
    ...
    <form action="{{ route('pelanggan.store') }}" method="POST">
        ...
        <div class="mb-3 d-flex align-items-center">
            ...
            <input type="text" class="form-control" id="kode_pelanggan" name="kode_pelanggan" value="{{ $kode_pelanggan }}" readonly style="width:300px;">
        </div>
        <div class="mb-3 d-flex align-items-center">
            <label for="nama_pelanggan" class="form-label mb-0" style="width:150px;">Nama Pelanggan</label>
            <input type="text" class="form-control" id="nama_pelanggan" name="nama_pelanggan" value="{{ old('nama_pelanggan') }}" required style="width:300px;">
