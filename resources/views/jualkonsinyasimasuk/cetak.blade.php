...
<head>
    <meta charset="UTF-8">
    <title>Nota Penjualan Konsinyasi Masuk - {{ $jual->no_jualkonsinyasi }}</title>
    <style>
...
<div class="nota-container">
    <div class="nota-header">
        ...
        <div class="nota-title">
            ...
            <div class="sub">Nota Penjualan Konsinyasi Masuk</div>
            <div class="sub">Tanggal Jual: {{ $jual->tanggal_jual }}</div>
        </div>
        <div class="nota-print no-print">
            <button onclick="window.print()" style="padding:4px 12px;">Print</button>
        </div>
    </div>
    <div class="nota-info" style="margin-top:8px;">Nomor Penjualan Konsinyasi: {{ $jual->no_jualkonsinyasi }}</div>
    ...
    <table class="nota-summary" style="margin-left:0; width: 350px;">
        <tr>
            <td class="fw-bold" style="width:170px;">Total Jual</td>
