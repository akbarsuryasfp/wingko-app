...
class JurnalHelper
{
    ...
    public static $akunMap = [
        ...
        'uang_muka'             => '1025', // Uang Muka Pembelian
        ...
        'mesin'                 => '1130', // Mesin
        'akumulasi_penyusutan_bangunan' => '1140', // Akumulasi Penyusutan Bangunan
        'akumulasi_penyusutan_mesin'    => '1141', // Akumulasi Penyusutan Mesin
        'utang_usaha'           => '2000', // Utang Usaha
        'hutang_konsinyasi'     => '2001', // Hutang Konsinyasi
        'utang_bank'            => '2010', // Utang Bank
        'utang_pajak'           => '2020', // Utang Pajak
        'modal_pemilik'         => '3000', // Modal Pemilik
        'prive'                 => '3010', // Prive
        'penjualan'             => '4000', // Penjualan
        'retur_penjualan'       => '4001', // Retur Penjualan
        ...
        'beban_penyusutan_bangunan' => '5012', // Beban Penyusutan Bangunan
        'beban_penyusutan_mesin'    => '5013', // Beban Penyusutan Mesin
        'upah'                  => '5020', // Beban Gaji/Upah/BTKL
        'overhead'              => '5030', // Beban Overhead Pabrik
        'beban_lain'            => '5040', // Beban Lain-lain
        'diskon_pembelian'      => '5050', // Diskon Pembelian
        'ongkos_kirim'          => '5060', // Ongkir Pembelian
        'diskon_penjualan'      => '5070', // Diskon Penjualan
